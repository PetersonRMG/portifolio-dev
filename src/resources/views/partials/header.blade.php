                    ...
                    <div class="header-left ">
                        <ul class="list">
                            ...
                            <li>
                                ...
                                <a href="mailto:hello@neotix.com">hello@neotix.com</a>
                            </li>
                        </ul>
                    </div>
                    <div class="header-right">
                        <span><i class="fa-regular fa-clock"></i> Mon–Fri 09:00 AM – 06:00 PM</span>
                                                    ...
                                                    <div class="homemenu-items">
                                                        <div class="homemenu">
                                                            <div class="homemenu-thumb">
                                                                <img src="{{ asset('peterson/img/header/home-1.jpg') }}"
                                                                    alt="img">
                                                        ...
                                                        <div class="homemenu">
                                                            <div class="homemenu-thumb mb-15">
                                                                <img src="{{ asset('peterson/img/header/home-2.jpg') }}"
                                                                    alt="img">
                                                                <div class="demo-button">
                                                        ...
                                                        <div class="homemenu">
                                                            <div class="homemenu-thumb mb-15">
                                                                <img src="{{ asset('peterson/img/header/home-3.jpg') }}"
                                                                    alt="img">
                                                                <div class="demo-button">
                                                        ...
                                                        <div class="homemenu">
                                                            <div class="homemenu-thumb mb-15">
                                                                <img src="{{ asset('peterson/img/header/home-4.jpg') }}"
                                                                    alt="img">
                                                                <div class="demo-button">
